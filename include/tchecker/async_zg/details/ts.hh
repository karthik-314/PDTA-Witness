  ...
  namespace async_zg {
    ...
    namespace details {
      ...
      public:
        ...
        /*!
          \brief Placeholder, to be implemented later.
        */
        ...
        */
        ...
        /*!
          \brief Placeholder, to be implemented later.
        */
        virtual std::pair<bool, std::pair<bool, std::string>> edge_name(typename ASYNC_ZG::outgoing_edges_iterator_value_t const & v){
          return std::make_pair(0, std::make_pair(0, ""));
        }
        ...
        */
        ...
        virtual int get_event_id(typename ASYNC_ZG::outgoing_edges_iterator_value_t const & v){
          return -1;
        }
