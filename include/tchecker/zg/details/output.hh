...
namespace tchecker {
  ...
  namespace zg {
    ...
    namespace details {
      ...
      inline std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(tchecker::zg::details::transition_t const & t, tchecker::clock_index_t const & clock_index){
        return tchecker::ta::details::get_g_n_r(t, clock_index);
      }
      ...
      public:
        ...
        inline std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(tchecker::zg::details::transition_t const & t){
          return tchecker::zg::details::get_g_n_r(t, _clock_index);
        }
      };
