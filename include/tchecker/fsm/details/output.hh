...
namespace tchecker {
  ...
  namespace fsm {
    ...
    namespace details {
      ...
      inline std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(tchecker::fsm::details::transition_t const & t){
        // std::cout << "Karthik\n";
      ...
      public:
        ...
        inline std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(tchecker::fsm::details::transition_t const & t){
          return tchecker::fsm::details::get_g_n_r(t);
        }
      };
