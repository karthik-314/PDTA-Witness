      ...
      public:
        ...
        */
        ...
        /*!
          \brief Placeholder, to be implemented later.
        */
        virtual std::pair<bool, std::pair<bool, std::string>> edge_name(typename FSM::outgoing_edges_iterator_value_t const & v){
...
<<<<<<< HEAD
        ...
        */
=======
        virtual int get_event_id(typename FSM::outgoing_edges_iterator_value_t const & v){
          return -1;
        }
