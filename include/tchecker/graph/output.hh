...
namespace tchecker {
  ...
  namespace graph {
    ...
    public:
      ...
      virtual std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(NODE const & src, NODE const & tgt, EDGE const &edge){
        return this->_edge_outputter.get_g_n_r(edge);
        // std::vector<std::tuple<std::string, int, int>> x;
    ...
    public:
      ...
      virtual std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(NODE const & src, NODE const & tgt, EDGE const &edge){
        // this->_edge_outputter.get_g_n_r(edge);
        std::vector<std::tuple<std::string, int, int>> x;
        std::vector<std::string> y;
        return std::make_pair(x, y);
      }
