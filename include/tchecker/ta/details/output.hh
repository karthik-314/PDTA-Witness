  ...
  namespace ta {
    ...
    namespace details {
      ...
      public:
        ...
        inline std::pair<std::vector<std::tuple<std::string, int, int>>, std::vector<std::string>> get_g_n_r(tchecker::ta::details::transition_t const & t){
          return tchecker::ta::details::get_g_n_r(t, _clock_index);
        }
