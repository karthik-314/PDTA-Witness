...
namespace tchecker {
  ...
  namespace parsing {
    ...
    /*!
      ...
      \brief Stack Operation for an Edge
    */
    class stack_op {
    public:
      /*!
       \brief Constructor
       \param key : Stack operation key
       \param value : Stack operation value
       \param key_context : contextual information for key (position in input
       file, etc)
       \param value_context : contextual information for value (position in
       input file, etc)
       */
      stack_op(std::string const & key,
          std::string const & value,
          std::string const & key_context,
          std::string const & value_context);
      /*!
      ...
      */
      ...
      /*!
       ...
       \post this is a copy of sop
       */
      stack_op(tchecker::parsing::stack_op const & sop){
        this->_key = sop._key;
        this->_value = sop._value;
        this->_key_context = sop._key_context;
        this->_value_context = sop._value_context;
      }

      /*!
       \brief Move constructor
       \param sop : Stack Operation
       \post sop has been moved to this
       */
      stack_op(tchecker::parsing::stack_op && sop) = default;
      ...
      /*!
       ...
       \post this is a copy of sop
       */
      tchecker::parsing::stack_op & operator=(tchecker::parsing::stack_op const & sop){
        this->_key = sop._key;
        this->_value = sop._value;
        this->_key_context = sop._key_context;
        this->_value_context = sop._value_context;
      ...
      /*!
       ...
       \post sop has been moved to this
       */
      tchecker::parsing::stack_op & operator=(tchecker::parsing::stack_op && sop) = default;

      /*!
       \brief Accessor
       \return Stack Operation key
       */
      inline std::string const & key() const
      {
        return _key;
  ...
  /*!
   ...
   \param os : output stream
   \param sop : Stack Operation
   \post sop has been output to os
   \return os after sop has been output
  */
  std::ostream & operator<< (std::ostream & os, tchecker::parsing::stack_op const & sop);
    ...
    public:
      ...
      edge_declaration_t(tchecker::parsing::process_declaration_t const & process,
                         ...
                         tchecker::parsing::attributes_t && attr,
                         tchecker::parsing::stack_op const & sop);
      ...
      */
      inline tchecker::parsing::stack_op const & stack_operation() const{
        return _stack_op;
      }
    private:
      /*!
      ...
      tchecker::parsing::attributes_t const _attr;                /*!< Attributes */
      tchecker::parsing::stack_op const & _stack_op;              /*!< Stack Operation */
    };
